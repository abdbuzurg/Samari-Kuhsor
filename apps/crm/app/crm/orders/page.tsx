...
/**
 * Заказы клиентов — the sales-order list.
 *
 * Moved out of `/crm` in R13. It had been occupying the CRM module's own route
 * while implementing none of the specification at docs/05-MODULES.md:179 — not
 * one of the six columns specified there matched. The module is the customer
 * pipeline; this is one view within it.
 */
  ...
  return (
    <AppShell>
      <ListView<SalesOrderRow>
        ...
        onCreate={mayManage ? () => router.push('/crm/orders/new') : undefined}
