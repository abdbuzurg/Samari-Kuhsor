...
var everyGuardedRoute = []routeCase{
	...
	{"GET", "/api/v1/cms/pages/" + zeroUUID + "/blocks", "cms:read", ""},
	{"PUT", "/api/v1/cms/pages/" + zeroUUID + "/blocks", "cms:manage", `{"block_key":"hero","sort_order":0,"locale":"ru"}`},
	{"POST", "/api/v1/cms/pages/" + zeroUUID + "/transition", "cms:manage", `{"to":"technical_review"}`},
	{"GET", "/api/v1/cms/pages/" + zeroUUID + "/history", "cms:read", ""},
	{"GET", "/api/v1/cms/news", "cms:read", ""},
	{"POST", "/api/v1/cms/news", "cms:manage", `{"slug":"test-post"}`},
	{"GET", "/api/v1/cms/news/" + zeroUUID + "/translations", "cms:read", ""},
	{"PUT", "/api/v1/cms/news/" + zeroUUID + "/translations", "cms:manage", `{"locale":"ru","title":"Тест"}`},
	{"POST", "/api/v1/cms/news/" + zeroUUID + "/transition", "cms:manage", `{"to":"technical_review"}`},
	{"GET", "/api/v1/cms/news/" + zeroUUID + "/history", "cms:read", ""},
	{"GET", "/api/v1/cms/media", "cms:read", ""},
	{"PUT", "/api/v1/cms/media/" + zeroUUID + "/alt", "cms:manage", `{"alt_ru":"Описание","version":1}`},
